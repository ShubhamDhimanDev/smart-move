...
<nav class="sticky top-0 z-50 glass border-b border-white/[0.06] w-full">
    <div class="container mx-auto px-6 lg:px-10 max-w-7xl flex items-center justify-between h-16">
        ...
        <div class="hidden lg:flex items-center gap-8 text-sm font-headline font-semibold">
                        ...
                        <div class="grid grid-cols-3 gap-8">
                            ...
                            <div style="background:rgba(239,165,0,0.06);border:1px solid rgba(239,165,0,0.13)" class="rounded-sm p-5 flex flex-col justify-between">
                                <div>
                                    ...
                                    <a href="{{ route('applications.create') }}" class="mt-5 bg-secondary-container text-on-secondary py-2.5 px-4 rounded-full text-xs font-bold w-fit hover:scale-105 transition-transform inline-block">Apply Now &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <a class="bg-secondary-container text-on-secondary px-5 py-2 rounded-full font-headline font-bold text-sm hover:scale-105 transition-transform duration-200 shadow-lg shadow-secondary-container/20" href="{{ route('applications.create') }}">Apply Now</a>
    ...
    <div id="mob-menu" class="hidden lg:hidden glass border-t border-white/[0.06] px-6 py-6 space-y-4">
        ...
        <div class="pt-2 border-t border-white/10 text-sm text-on-surface-variant"> 020 7790 9233 &nbsp; info@smartmove-eg.com</div>
    </div>
</nav>
    ...
    <div class="relative z-10 container mx-auto px-6 lg:px-10 max-w-7xl w-full pt-20 pb-44">
        <div class="max-w-[52rem]">
            ...
            <div class="flex flex-wrap gap-4 animate-fadeUp-d2">
                <a class="bg-secondary-container text-on-secondary px-8 py-4 rounded-full font-headline font-bold text-base hover:scale-105 transition-transform shadow-2xl shadow-secondary-container/20 flex items-center gap-2" href="{{ route('applications.create') }}">
...
<section class="py-32 relative overflow-hidden bg-background">
    ...
    <div class="container mx-auto px-6 lg:px-10 max-w-5xl text-center relative z-10 reveal">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto text-sm font-label tracking-wide">
            ...
            <div class="flex flex-col items-center gap-2 text-on-surface-variant"><span class="material-symbols-outlined text-secondary-container text-2xl">mail</span><a href="mailto:info@smartmove-eg.com" class="hover:text-white transition-colors">info@smartmove-eg.com</a></div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-12">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-white/40">
                    ...
                    <li><a href="mailto:info@smartmove-eg.com" class="hover:text-white transition-colors">info@smartmove-eg.com</a></li>
