...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #111827;">
    ...
    <ul>
        ...
        <li><strong>Nationality &amp; Immigration Status:</strong> {{ $application->nationality_immigration_status }}</li>
        <li><strong>Preferred Course &amp; Location:</strong> {{ $application->preferred_course_location }}</li>
        <li><strong>Have Taken SFE Before:</strong> {{ $application->has_taken_sfe_before ? 'Yes' : 'No' }}</li>
        <li><strong>Previous Qualification / Work Experience:</strong> {{ $application->previous_qualification_work_experience }}</li>
